...
import { getUsers } from '../../api/sregist';
...
interface StudentState {
  ...
  studentFormData: Partial<Users>;
  status: 'idle' | 'loading' | 'succeeded' | 'failed';
  error: string | null;
}

export const fetchStudentData = createAsyncThunk<Users[], void>(
...
export const registerStudent = createAsyncThunk<
  Users,
  Partial<Users>, // เปลี่ยนเป็น Partial<Student> เพื่อรองรับข้อมูลที่ไม่ครบถ้วน
  { rejectValue: string }
>(
  'student/register',
  async (studentData: Partial<Users>, { rejectWithValue }) => {
    try {
